...
public class VideoResp {
    ...
    /**
     * activityId : string
     * artActivity : {"LOGO":"string","activityId":"string","bannerPath":"string","browseSum":0,"content":"string","createPerson":"string","endDate":"2018-07-02T02:22:00.058Z","enterpriseId":"string","enterpriseName":"string","forwardSum":0,"linkPath":"string","linkPathSum":0,"linkPathTo":0,"logo":"string","manBrowseSum":0,"money":0,"partitionMoney":0,"payStatus":0,"slogan":"string","status":0,"videoCount":0,"videoExamplePath":"string","videoWatchSum":0,"woManBrowseSum":0}
     * coverPath : string
     * coverPathTwo : string
     * describes : string
    ...
    public static class ArtActivityBean {
         ...
         * content : string
         * createPerson : string
         * endDate : 2018-07-02T02:22:00.058Z
         * enterpriseId : string
         * enterpriseName : string
         * forwardSum : 0
         * linkPath : string
