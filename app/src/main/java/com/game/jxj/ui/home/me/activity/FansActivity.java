...
public class FansActivity extends SimpleActivity implements SwipeRefreshLayout.OnRefreshListener
    ...
    public static void launch(Context context) {
        ActivityUtil.startActivity(context, FansActivity.class);
    }
    ...
    protected void initEventAndData() {
        titleBar.setTitleText(R.string.my_fans);
        ...
        getHttpHelper().getFollowList(listReq)
                ...
                .subscribeWith(new SimpleCommonSubscriber<Optional<List<FollowListResp>>>(mContext) {
                                   ...
                                   public void onNext(Optional<List<FollowListResp>> listOptional) {
                                       List<FollowListResp> resps = listOptional.get();
                                       if (page == 1) {
                                           //1刷新
